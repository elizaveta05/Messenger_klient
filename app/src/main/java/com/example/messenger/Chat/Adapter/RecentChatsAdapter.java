...
public class RecentChatsAdapter extends RecyclerView.Adapter<RecentChatsAdapter.ViewHolder> {
    ...
    private final List<RecentChats> chatList;
    private final LayoutInflater inflater;
    private final OnUserClickListener onUserClickListener;

    public RecentChatsAdapter(Context context, List<RecentChats> chatList, OnUserClickListener listener) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.all_chats_adapter, parent, false);
